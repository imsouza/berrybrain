      ...
      <main className="min-h-screen bg-background text-foreground">
        <header className="sticky top-0 z-40 border-b border-border/70 bg-background/92 backdrop-blur">
          ...
          <Link href="/" className="flex items-center gap-3">
            <Image src="/berrylogo.png" alt="BerryBrain" width={48} height={48} className="rounded-md" />
            <span className="text-lg font-semibold tracking-tight">BerryBrain</span>
          </Link>
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-5 py-10 md:grid-cols-[1.1fr_2fr] md:px-6">
        <div>
          <div className="flex items-center gap-3">
            <Image src="/berrylogo.png" alt="BerryBrain" width={48} height={48} className="rounded-md grayscale" />
            <span className="text-lg font-semibold">BerryBrain</span>
          </div>
