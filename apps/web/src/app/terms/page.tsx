...
export default function Terms() {
  return (
    <LegalPage title="Terms">
      ...
      <p>The system may use local or configured cloud providers. Provider use must be configured by the user or administrator.</p>
      ...
      <p>Administrative access is limited and audited. Account misuse, abuse automation, credential stuffing, or attempts to bypass protective controls may lead to account restrictions.</p>
      <p>Support and account requests: contato@optlabs.com.br.</p>
    </LegalPage>
  );
}
