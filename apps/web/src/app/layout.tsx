  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem("bb_theme")||"light";var p={light:{bg:"#FAF8F5",fg:"#1D1B18",mu:"#5C5C5C",pn:"#FFFFFF",bd:"#E4E0D8",ac:"#BF1755",ah:"#A81249",as:"#F1D5DF"},dark:{bg:"#121212",fg:"#E8E8E8",mu:"#B5AFA7",pn:"#1D1B19",bd:"#393530",ac:"#BF1755",ah:"#D12A69",as:"#422631"}}[t]||p.light;var fs=localStorage.getItem("bb_font_size")||"15";var uf=localStorage.getItem("bb_ui_font")||"inter";var edf=localStorage.getItem("bb_editor_font")||"mono";var ufm={inter:'"Inter",ui-sans-serif,system-ui,sans-serif',system:'ui-sans-serif,system-ui,-apple-system,sans-serif'};var efm={mono:'"Geist Mono","JetBrains Mono",ui-monospace,monospace',sans:'ui-sans-serif,system-ui,sans-serif'};var root=document.documentElement;var r=root.style;root.setAttribute("data-theme",t);root.lang="en";r.setProperty("--color-background",p.bg);r.setProperty("--color-foreground",p.fg);r.setProperty("--color-muted",p.mu);r.setProperty("--color-panel",p.pn);r.setProperty("--color-border",p.bd);r.setProperty("--color-accent",p.ac);r.setProperty("--color-accent-hover",p.ah);r.setProperty("--color-accent-soft",p.as);r.setProperty("--color-brand-green","#83A637");r.setProperty("--color-brand-red","#BF1755");r.setProperty("--color-danger","#BF1755");r.setProperty("--font-ui",ufm[uf]||ufm.inter);r.setProperty("--font-editor",efm[edf]||efm.mono);if(document.body){document.body.style.fontSize=fs+"px";document.body.style.fontFamily="var(--font-ui)";}}catch(e){}})();`,
          }}
        />
      </head>
