...
> Historical audit only. Current assessments use the evidence-based Maturity V3 model documented
> in `docs/maturity-model.md`; percentages in this file must not be used as current evidence.
